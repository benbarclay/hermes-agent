...
# Gemini Auth is a hidden (pre-release) OAuth provider deliberately kept out of PROVIDER_REGISTRY,
# so resolve_provider() would raise "Unknown provider" before any provider-specific rung ran.
_GEMINI_AUTH_NAMES = ("gemini-auth", "google-gemini-auth", "gemini-auth-oauth")
